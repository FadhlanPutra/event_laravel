                    ...
                    <section class="bg-white py-8 antialiased dark:bg-gray-900 md:py-16">
                        <div class="mx-auto grid max-w-screen-xl px-4 pb-8 md:grid-cols-12 lg:gap-12 lg:pb-16 xl:gap-0">
                          <div class="content-center justify-self-start md:col-span-7 md:text-start">
                            <h1 class="mb-4 text-4xl font-extrabold leading-none tracking-tight dark:text-white md:max-w-2xl md:text-5xl xl:text-6xl">Ikuti Event Terbakar Sekarang🔥!</h1>
                            <p class="max-w-2xl text-gray-500 dark:text-gray-400 md:mb-12 md:text-lg mb-7 lg:mb-5 lg:text-xl">Bebas <i style="font-size: 15px;">*kata Pepan</i></p>
                            <button type="button" class="inline-block rounded-lg bg-primary-700 px-6 py-3.5 text-center font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                                <nav class="-mx-3 flex flex-1 justify-end text-white">
                                    @if (Route::has('login'))
                                @auth
                                    <a
                                        href="{{ url('/dashboard') }}"
                                        class="rounded-md px-3 text-white ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white"
                                    >
                                        Dashboard
                                    </a>
                                @else
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <form method="POST" action="{{ route('login') }}" style="color:black;">
                ...
                <div>
                    ...
                    <!-- Password -->
                    <div class="mt-4 form-outline mb-4" style="position:relative;">
                        <x-input-label for="password" :value="__('Password')" />
                        
                        <div class="flex item-center relative">
                            <x-text-input id="login-password" class="mt-1 w-full"
                            type="password"
                            name="password"
                            required autocomplete="current-password"/>
                            <button type="button" class="absolute inset-y-0 right-1 flex items-center pl-3" onclick="togglePassword(document.getElementById('login-password'), document.getElementById('toggleLoginPasswordIcon'))">
                                    <i id="toggleLoginPasswordIcon" class="far fa-eye me-3"></i>
                            </button>
                        </div>
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mt-4">
                    ...
                    <div class="flex item-center" style="position:relative;">
                    <x-text-input id="register-password" class="block mt-1 w-full"
                                    type="password"
                                    name="password"
                                    required autocomplete="new-password" />
                                    <button type="button" class="absolute inset-y-0 right-1 flex items-center pl-3" onclick="togglePassword(document.getElementById('register-password'), document.getElementById('toggleRegisterPasswordIcon'))">
                                        <i id="toggleRegisterPasswordIcon" class="far fa-eye me-3"></i>
                                </button>
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="password_confirmation" class="block mt-1 w-full"
                                    ...
                                    <button type="button" class="absolute inset-y-0 right-1 flex items-center pl-3" onclick="togglePassword(document.getElementById('password_confirmation'), document.getElementById('togglePasswordConfirmIcon'))">
                                        <i id="togglePasswordConfirmIcon" class="far fa-eye me-3"></i>
                                    </button>
